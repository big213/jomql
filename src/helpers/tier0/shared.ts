...
export function validateObjectFields(obj: Object, fields: Array<String>) {
  const newObj = {};
...
export function collapseObject(obj: Object) {
...
export function collapseObjectArray(objArray: Array<Object>) {
